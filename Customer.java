                    ...
                    switch (choice){
                        ...
                        while (!end1) {
                            try {
                                ...
                                crs.next();
                                int count = crs.getInt(1);  //count = count number of records
                                if (count > 0) {
                                    end1 = true;
                        ...
                        while (!end2) {
                            ...
                            if (title.charAt(0) != '%' && title.charAt(0) != '_'){  //The first letter is not _ or %
                                if (title.charAt(title.length() - 1) != '%' && title.charAt(title.length() - 1) != '_'){  //Base Case (No % and _)
                                    ...
                                    if (count_exist > 0) {
                                        end2 = true;
                                        String query = "SELECT * FROM Book WHERE BINARY title = \"" + title + "\"";
                                        ResultSet rs = stmt.executeQuery(query);
                                        while (rs.next()){
                                            System.out.println("Record " + count);
                                            count++;
                                    ...
                                    if (count_exist > 0) {
                                        end2 = true;
                                        String query = "SELECT * FROM Book WHERE BINARY title Like \'" + title + "_\'";
                                        ResultSet rs = stmt.executeQuery(query);
                                        while (rs.next()){
                                            System.out.println("Record " + count);
                                            count++;
                                ...
                                if (title.charAt(title.length() - 1) != '_' && title.charAt(title.length() - 1) != '%') {  //The last letter is not _ nor %
                                    ...
                                    if (count_exist > 0) {
                                        end2 = true;
                                        String query = "SELECT * FROM Book WHERE BINARY title Like \'_" + title + "\'";
                                        ResultSet rs = stmt.executeQuery(query);
                                        while (rs.next()){
                                            System.out.println("Record " + count);
                                            count++;
                                    ...
                                    if (count_exist > 0) {
                                        end2 = true;
                                        String query = "SELECT * FROM Book WHERE BINARY title Like \'_" + title + "_\'";
                                        ResultSet rs = stmt.executeQuery(query);
                                        while (rs.next()){
                                            System.out.println("Record " + count);
                                            count++;
                        ...
                        while (!end3) {
                            ...
                            if (author.charAt(0) != '%' && author.charAt(0) != '_') {
                                if (author.charAt(author.length() - 1) != '%' && author.charAt(author.length() - 1) != '_') {
                                    ...
                                    if (count_exist > 0) {
                                        end3 = true;
                                        String query = "SELECT * FROM Book WHERE ISBN IN (SELECT ISBN FROM Book_author WHERE BINARY author_name = \"" + author + "\")";
                                        ResultSet rs = stmt.executeQuery(query);
                                        //System.out.println("\nRecord "+ count);
                                        while (rs.next()){
                                            System.out.println("Record " + count);
                                    ...
                                    if (count_exist > 0) {
                                        end3 = true;
                                        String query = "SELECT * FROM Book WHERE ISBN IN (SELECT ISBN FROM Book_author WHERE BINARY author_name Like \'" + author + "_\')";
                                        ResultSet rs = stmt.executeQuery(query);
                                        //System.out.println("\nRecord "+ count);
                                        while (rs.next()){
                                            System.out.println("Record " + count);
                                ...
                                if (author.charAt(author.length() - 1) != '%' && author.charAt(author.length() - 1) != '_') {
                                    ...
                                    if (count_exist > 0) {
                                        end3 = true;
                                        String query = "SELECT * FROM Book WHERE ISBN IN (SELECT ISBN FROM Book_author WHERE BINARY author_name Like \'_" + author + "\')";
                                        ResultSet rs = stmt.executeQuery(query);
                                        //System.out.println("\nRecord "+ count);
                                        while (rs.next()){
                                            System.out.println("Record " + count);
                                    ...
                                    if (count_exist > 0) {
                                        end3 = true;
                                        String query = "SELECT * FROM Book WHERE ISBN IN (SELECT ISBN FROM Book_author WHERE BINARY author_name Like \'_" + author + "_\')";
                                        ResultSet rs = stmt.executeQuery(query);
                                        //System.out.println("\nRecord "+ count);
                                        while (rs.next()){
                                            System.out.println("Record " + count);
